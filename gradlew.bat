...
@if "%DEBUG%"=="" @echo off
@rem Use UTF-8 for Gradle and JOSM output in Windows PowerShell/cmd.
@chcp 65001 >NUL
@rem Use UTF-8 before Gradle or JOSM writes anything to the Windows console.
chcp 65001 >NUL
@rem ##########################################################################
@rem
...
@rem Keep the Gradle distribution and dependency cache inside this project.
